...
###### yes, given an array A of integers and an array (B) of arrays that contain several integers. Output an array of integers how many arrays in the array B include each integer
