...
###### yes, given an array A of strings and an array (B) of arrays that contain several char. Output an array of integers. In the array, each in integer represents how many arrays in the array B include a
