...
#### yes, for the hotel problem, the queries could be an array of arrays, which might be asking how many rooms have been occupied / generating money during that period of time
